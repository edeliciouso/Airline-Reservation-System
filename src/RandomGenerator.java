...
public class RandomGenerator {
    ...
    // generates random ID for passengers
    public void randomIDGen() {
        Random rand = new Random();
        String randomID = Integer.toString(rand.nextInt(1000000)); // make random ID, limit the number by 1,000,000
    ...
    // sets destinations for each of the flights from the above destinations randomly
    ...
    // generates random number of seats each flight
    public int randomNumOfSeats() {
        Random random = new Random();
        int numOfSeats = random.nextInt(500); // randomize a number, limit is 500
